...
from app.linguistics.models import LanguageProfile, LanguageType, LinguisticEnrichment
...
class CanonicalConceptMapper:
    ...
    def map_concepts(cls, query: str, profile: LanguageProfile) -> LinguisticEnrichment:
        ...
        return LinguisticEnrichment(
            ...
            metadata={"target_doc_types": [cls.CONCEPT_PATTERNS[c]["target_doc_type"] for c in matched_concepts]},
        )
